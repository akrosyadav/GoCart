...
<div class="container ">
       ...
       <br/><br/>
		...
		<p class="lead">Please Fill your details here:</p>
			...
			<form:form class="form-horizontal" action="${pageContext.request.contextPath}/add_Customer"  method="post"  commandName="customer" >
				...
				<div class="form-group">
					...
					<form:input path="password" type="text" class="form-control" placeholder="" />
				</div>
				</div>
